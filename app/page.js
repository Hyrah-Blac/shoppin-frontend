...
const breakpoints = { default: 5, 1400: 4, 1100: 3, 700: 2, 500: 2 };
  ...
  return (
    <div>
        ...
        {CATEGORIES.map((c) => (
          <button
            ...
            style={{
              ...
              background: category === c ? '#111' : '#efefef',
      ...
      <div style={{ padding: 16 }}>
        {error && (
          <div style={{
            textAlign: 'center', padding: 40, color: '#e60023',
            background: '#fff0f0', borderRadius: 12, marginBottom: 20,
          }}>
            <p style={{ fontWeight: 600, marginBottom: 8 }}>Could not reach backend</p>
        ...
        {!loading && !error && products.length === 0 && (
          <div style={{ textAlign: 'center', padding: '80px 20px' }}>
            <p style={{ fontSize: 22, fontWeight: 600, marginBottom: 8 }}>No products yet</p>
            <p style={{ color: '#888', marginBottom: 24 }}>Be the first to upload!</p>
            <a href="/upload" style={{
              background: '#e60023', color: '#fff',
              padding: '12px 28px', borderRadius: 24,
              fontWeight: 600, fontSize: 15,
            }}>Upload first product</a>
          </div>
        )}

        {!hasMore && products.length > 0 && (
          <p style={{ textAlign: 'center', padding: 24, color: '#888', fontSize: 14 }}>
